...
//int binario_pra_decimal(int binario1, int binario2, int binario3) {
...
//}
//
//int binario_pra_decimal_grande(int binarios[], int tamanho_do_vetor) {
//    int decimal = 0;
...
//    }
//    int decimal_opcode = binario_pra_decimal_grande(array_pra_converter, 6);
//    printf("%d (%s)", decimal_opcode, nomes_do_opcode_r[decimal_opcode]);
//    printf("\n");
//
//    printf("  Destino:  ");
//    int binariodest1 = 0;
...
//        }
//    }
//    printf("r%d", binario_pra_decimal(binariodest1, binariodest2, binariodest3));
//    printf("\n");
//
//    printf("  Operando 1:   ");
//    int binarioop11 = 0;
...
//        }
//    }
//    printf("r%d", binario_pra_decimal(binarioop11, binarioop12, binarioop13));
//    printf("\n");
//
//    int binarioop21 = 0;
//    int binarioop22 = 0;
...
//        }
//    }
//    printf("r%d", binario_pra_decimal(binarioop21, binarioop22, binarioop23));
//    printf("\n");
//
//    printf("  Completo: ");
//    for (int j = 15; j >= 0; j--) {
...
//    printf("  Opcode: ");
//    int array_pra_converter_opcode[2];
//    for (int j = 15; j >= 14; j--) {
//        int bit = (instrucao & (1 << j)) ? 1 : 0;
//        array_pra_converter_opcode[15 - j] = bit;
//    }
//    int decimal_opcode = binario_pra_decimal_grande(array_pra_converter_opcode, 2);
//    printf("%d (%s)", decimal_opcode, nomes_do_opcode_I[decimal_opcode]);
//    printf("\n");
//
//    printf("  Registrador:  ");
//    int binariodest1 = 0;
...
//    }
//    printf("%d", binario_pra_decimal_grande(array_pra_converter, 10));
//    printf("\n");
//
//    printf("  Completo: ");
//    for (int j = 15; j >= 0; j--) {
